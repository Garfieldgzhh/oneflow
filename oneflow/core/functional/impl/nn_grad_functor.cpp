...
class DistributedSparseCrossEntropyGradFunctor {
 public:
  DistributedSparseCrossEntropyGradFunctor() {
...
ONEFLOW_FUNCTION_LIBRARY(m) {
  ...
  m.add_functor<impl::DistributedSparseCrossEntropyGradFunctor>("DistributedSparseCrossEntropyGrad");
